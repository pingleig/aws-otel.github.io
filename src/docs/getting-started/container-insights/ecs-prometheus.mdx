...
- [ ] add a getting start section
- [ ] explain different workload and their configuration
...
label `__meta_ecs_ec2_public_ip` which can be used in relabel config and override `__address__`.
